...
public class DriverOpMode extends OpMode {
    ...
    public void init() {
        ...
        shoulderMotor.setMode(DcMotor.RunMode.RESET_ENCODERS);
    ...
    public void loop() {
        ...
        if (gamepad1.a || gamepad1.b) {
            ...
            if (movingRearWheelsHoldingPos) {
                ...
                rearWheels.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODERS);
        ...
        if (gamepad2.start){
            if (! pullingUp) {
                pullingUp = true;
                puller.setMode(DcMotor.RunMode.RUN_USING_ENCODERS);
                puller.setPower (1.0);
            }
        } else {
            if (pullingUp){
    ...
    public void moveShoulder(double speed) {
        ...
        shoulderMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODERS);
